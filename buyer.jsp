...
<!-- NAV SECTION -->
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="buyerOrderDetails">CART</a></li>
	...
	<br>
	<br>
	<a href="buybooks" class="button"> <span>Buy<br>Books</span></a>
	<a href="buyerOrderDetails" class="button"> <span>My<br>Orders</span></a>
	<a href="#" class="button"> <span>Update<br>Profile</span></a>
	<a href="#" class="button"> <span>Shopping<br>Cart</span></a>
